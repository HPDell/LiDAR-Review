...
\begin{figure}[htbp]
	\centering
	\subfloat[本征半导体能带结构]{\includegraphics[height=3.7cm]{figure/Chapter2/本征半导体能带结构}\label{fig:本征半导体能带结构}}
	\hfill
	\subfloat[P-N结]{\includegraphics[height=3.7cm]{figure/Chapter2/P-N结}\label{fig:p-n结}}
	\hfill
	\subfloat[p-n结产生激光]{\includegraphics[height=3.7cm]{figure/Chapter2/p-n结产生激光}\label{fig:p-n结产生激光}}
\end{figure}
