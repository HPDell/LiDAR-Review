...
%\begin{figure}[htbp]
%	\centering
%	\subfloat[圆锥镜扫描原理]{\includegraphics[height=4cm]{figure/Chapter1/圆锥镜扫描_原理}}\hspace{3em}
%	\subfloat[圆锥镜扫描脚点形状]{\vspace{0.75cm}\includegraphics[height=2.5cm]{figure/Chapter1/圆锥镜扫描_脚点}\vspace{0.75cm}}
%	\caption{圆锥镜扫描方式}。
%	\label{fig:圆锥镜扫描方式}
%\end{figure}
\newsavebox{\tempbox}
\begin{figure}[htbp]
	\centering
	\sbox{\tempbox}{\includegraphics[height=4cm]{figure/Chapter1/圆锥镜扫描_原理}}
	\subfloat[圆锥镜扫描原理]{\usebox{\tempbox}}
	\subfloat[圆锥镜扫描脚点]{
		\vbox to \ht\tempbox{
			\vfil
			\includegraphics[height=2.5cm]{figure/Chapter1/圆锥镜扫描_脚点}
			\vfil
		}
	}
	\caption{圆锥镜扫描方式}
